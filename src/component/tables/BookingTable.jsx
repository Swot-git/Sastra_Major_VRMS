...
const BookingLogTable = () => {
  ...
  const columns = [
    { field: 'timestamp', headerName: 'Timestamp', width: 200, headerClassName: 'table-header' },
    { field: 'vehicleType', headerName: 'Vehicle Type', width: 150, headerClassName: 'table-header'},
    { field: 'vehicleModel', headerName: 'Vehicle Model', width: 150, headerClassName: 'table-header' },
    ...
    { field: 'startDate', headerName: 'From', width: 150, headerClassName: 'table-header' },
    { field: 'endDate', headerName: 'To', width: 150, headerClassName: 'table-header' },
