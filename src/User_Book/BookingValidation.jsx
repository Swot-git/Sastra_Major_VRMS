...
const BookingValidation = () => {
  ...
  if (!vehicle) {
    navigate('/ViewVehicleBookingCarPage'); // Redirect to the previous page if vehicle is null
    return null;
  }
  ...
  const handleBooking = async (event) => {
    ...
    if (checkAvailability(new Date(startDate), new Date(endDate))) {
      try {
        ...
        setTimeout(() => {
          navigate('/ViewVehicleBookingCarPage'); // Redirect to the booking page
  ...
  const handleCancel = () => {
    navigate('/ViewVehicleBookingCarPage'); // Navigate back to the booking page
  };
